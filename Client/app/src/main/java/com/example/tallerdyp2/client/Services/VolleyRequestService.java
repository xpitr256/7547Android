...
public class VolleyRequestService {
    ...
    public void createSplexUser(final Callable call, final JSONObject data, String provider) {
    ...
    public void logSplexUser(final Callable call, final JSONObject data, String provider) {
